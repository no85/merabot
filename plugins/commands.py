...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/newwtel'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/m4moviesmtech2')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ SUBSCᏒIBΞ  ✅', url='https://youtube.com/shorts/CNGd0POAQl4?feature=share')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)        
